...
import static org.springframework.batch.item.data.TestDatabase.OPENSEARCH_2;

@Testcontainers
@SpringJUnitConfig
class Opensearch2IntegrationTest {

	@Container
	static OpensearchContainer<?> container = new OpensearchContainer<>(OPENSEARCH_2.getImageName());
