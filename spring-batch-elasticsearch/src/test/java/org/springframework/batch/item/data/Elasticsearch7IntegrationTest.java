...
class Elasticsearch7IntegrationTest {
	...
	static class JobConfiguration {
		...
		ItemProcessor<Integer, IndexQuery> itemProcessor() {
			return i -> {
				var item = new Elasticsearch8IntegrationTest.TestItem(String.valueOf(i));
		...
		ElasticsearchItemWriter elasticsearchItemWriter(ElasticsearchOperations elasticsearchOperations) {
			var indexCoordinates = elasticsearchOperations
				.getIndexCoordinatesFor(Elasticsearch8IntegrationTest.TestItem.class);
